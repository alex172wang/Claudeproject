                    ...
                    [
                        ...
                        dbc.CardBody(
                            dash_table.DataTable(
                                ...
                                data=[
                                    {'strategy': 'ETF轮动', 'status': '运行中', 'weight': '40%', 'return': '+28.5%', 'drawdown': '-8.2%', 'sharpe': '2.1'},
                                    {'strategy': '永久组合', 'status': '运行中', 'weight': '35%', 'return': '+15.3%', 'drawdown': '-5.1%', 'sharpe': '1.4'},
                                    {'strategy': '主题仓位', 'status': '待机', 'weight': '25%', 'return': '+32.1%', 'drawdown': '-12.5%', 'sharpe': '1.8'},
                                ],
                                style_header={
                    ...
                    [
                        ...
                        dbc.CardBody(
                            dash_table.DataTable(
                                ...
                                data=[
                                    {'time': '14:32:15', 'type': '买入', 'symbol': '510300', 'price': '4.125', 'quantity': '5000', 'pnl': '-'},
                                    {'time': '14:28:03', 'type': '卖出', 'symbol': '510500', 'price': '6.823', 'quantity': '3000', 'pnl': '+1,245'},
                                    {'time': '14:15:22', 'type': '买入', 'symbol': '518880', 'price': '3.956', 'quantity': '2000', 'pnl': '-'},
                                    {'time': '13:45:10', 'type': '卖出', 'symbol': '159949', 'price': '1.234', 'quantity': '8000', 'pnl': '-2,110'},
                                ],
                                style_header={
                                    'backgroundColor': THEME['bg_light'],
                                    'fontWeight': 'bold',
...
def create_position_pie_figure() -> go.Figure:
    ...
    labels = ['沪深300ETF', '中证500ETF', '黄金ETF', '创业板ETF', '纳斯达克ETF', '现金']
    values = [350000, 280000, 150000, 120000, 180000, 165678.9]
